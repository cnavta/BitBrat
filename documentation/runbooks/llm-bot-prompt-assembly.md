...
- PERSONALITY_COLLECTION: Database collection/table for personalities.
...
- Personality missing: ensure PERSONALITY_ENABLED=true and the database record is active.
