...
## Partial
- [ ] Sprint publication/retro/closure artifacts are intentionally not started because the user has not requested `Sprint complete.` yet.

## Deferred
- [ ] Sprint publication, retro, and closure artifacts remain deferred until the user explicitly ends the sprint per AGENTS.md.
