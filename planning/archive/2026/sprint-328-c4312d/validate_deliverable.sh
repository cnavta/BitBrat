#!/usr/bin/env bash
# Validation for sprint-328-c4312d (Just-in-Time Context Provisioning / Context Packs).
...
echo "🧪 Running the full Jest suite (incl. context + drift + integration tests)..."
npm test
...
echo "🎯 Targeted context-provisioning suites (sprint-328 deliverable):"
npx jest tests/common/context tests/apps/context-provisioning.spec.ts
