...
describe('extract-config CLI', () => {
  it('emits oauth-flow config merged from architecture.yaml', () => {
    ...
    expect(json.ENV_KEYS).toEqual(['LOG_LEVEL','MESSAGE_BUS_DRIVER','NATS_URL','BUS_PREFIX','DISCORD_REDIRECT_URI','DISCORD_OAUTH_SCOPES','DISCORD_OAUTH_PERMISSIONS','TWITCH_OAUTH_SCOPES']);
